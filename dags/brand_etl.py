...
with DAG("etl_brand",
    ...
    table = "brand"
    file_prefix = f"{table}_230819/{table}_2023-08-19-19"
    ...
    # snowflake_task = CopyFromExternalStageToSnowflakeOperator(
    #     task_id="snowflake_task",
    #     s3_keys="",
    #     table=table,
    #     schema='RAW_DATA',
    #     stage=f"temp_{table}_{{{{ ts }}}}",
    #     file_format="parquet",
    # )

    start_task >> s3_copy_task >> spark_task >> end_task
